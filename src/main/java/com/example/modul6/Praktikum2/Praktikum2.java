...
public class Praktikum2 extends Application {
    ...
    private VBox createTableLayout(Stage primaryStage, Scene formScene) {
        ...
        TableColumn<Dosen, String> nimCol = new TableColumn<>("NIM");
        TableColumn<Dosen, String> emailCol = new TableColumn<>("Email");
        TableColumn<Dosen, String> fakultasCol = new TableColumn<>("Fakultas");
        TableColumn<Dosen, String> jurusanCol = new TableColumn<>("Jurusan");
        TableColumn<Dosen, String> alamatCol = new TableColumn<>("Alamat");
        TableColumn<Dosen, String> kotaCol = new TableColumn<>("Kota");
